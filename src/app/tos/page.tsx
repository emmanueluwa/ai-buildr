...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to Ai buildr. These Terms of Service (&quot;Terms&quot;) govern
        your use of our website and services, including any paid subscription
        plans. By accessing or using Ai buildr (&quot;the Service&quot;), you
        agree to be bound by these Terms. If you do not agree to these Terms, do
        not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        Ai buildr is a SaaS platform that provides resume-building tools powered
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> Ai buildr does not offer refunds for
      ...
      <p>
        Ai buildr grants you a limited, non-exclusive, non-transferable, and
      ...
      <p>
        ...
        Resume Builder are owned by Ai buildr or its licensors. You agree not to
        infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant Ai buildr a non-exclusive, worldwide,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). Ai buildr is not responsible for
      ...
      <p>
        ...
        available&quot; basis. Ai buildr makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, Ai buildr shall not be liable
      ...
      <p>
        By using Ai buildr, you acknowledge that you have read, understood, and
